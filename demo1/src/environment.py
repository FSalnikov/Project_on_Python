...
class Environment:
    """
        Класс для моделирования среды, в которой автомобиль выполняет действия,
        такие как движение и парковка. Среда включает в себя обработку коллизий,
        сенсоров, расчет награды и проверку состояния эпизода.

        Атрибуты:
        - WIDTH, HEIGHT: размеры окна игры (ширина и высота).
        - CAR_SIZE: размер машины в игре.
        - MAX_SPEED, MAX_SPEED_BACKWARD: максимальная скорость вперед и назад.
        - ACCELERATION, DECELERATION: ускорение и замедление автомобиля.
        - MIN_TURN_SPEED: минимальная скорость для поворота.
        - rectangle_width, rectangle_height: размеры прямоугольника, представляющего машину.
        - rectangle_surf: поверхность машины.
        - parking_spot: область парковки.
        - barrier_thickness: толщина барьеров.
        - barriers: список барьеров, окружающих среду.
        - car_rect: прямоугольник, представляющий машину.
        - rotated_collision_rect: прямоугольник для проверки коллизий с машиной.
        - custom_rectangles: список пользовательских препятствий.
        - initial_state: начальное состояние машины и окружающей среды.
        - current_state: текущее состояние машины и окружающей среды.
        - episode_finished: флаг завершения эпизода.
        - max_episode_steps: максимальное количество шагов в эпизоде.
        - current_step: текущий шаг в эпизоде.
        - best_distance: лучшее расстояние до парковки.
        - current_fitness: текущий показатель фитнеса.
        - ray_distances: список расстояний от сенсоров до препятствий.
        - average_distance: среднее расстояние от углов машины до парковки.
    """
